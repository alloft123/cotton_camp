...
//        $value = Mage::getResourceModel('customer/group_collection')
//           ->addFieldToFilter('customer_value', array('gt'=> 1))
//            ->load()
//            ->toOptionHash();
       ...
       $this->addColumn('status', array(
            ...
            'index'     =>  'status',
            'type'      =>  'options',
       //'options' => Mage::getSingleton( 'customer/entity_value' )->getOptionArray()
