...
class Mage_Adminhtml_Block_Catalog_Product_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
         /* Hiding ID Column in product Page*/
        ...
        /* Hiding Attribute Set name Column in product Page*/
        ...
        $this->addColumn('set_name',
         ...
         /* Hiding Type Column in product Page*/
         $this->addColumn('type',
            array(
         ...
         /* Hiding Visibility Column in product Page*/
         $this->addColumn('visibility',
           ...
           if (!Mage::app()->isSingleStoreMode()) {
            $this->addColumn('websites',
             ...
             /* Hiding Rss FeedBack Column in product Page*/
